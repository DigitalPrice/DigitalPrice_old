...
private slots:
    ...
    QString BuyDP(QString OrderType, double Quantity, double Rate);
    QString SellDP(QString OrderType, double Quantity, double Rate);
